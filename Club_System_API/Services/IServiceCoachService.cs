...
namespace Club_System_API.Services
{
    ...
    {
          Task<Result> AddCoachToServiceAsync(ServiceCoachRequest request, CancellationToken cancellationToken = default);
        Task<Result> RemoveCoachFromServiceAsync(ServiceCoachRequest request, CancellationToken cancellationToken = default);
