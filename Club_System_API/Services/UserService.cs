    ...
    ApplicationDbContext context) : IUserService
{
    ...
    public async Task<IEnumerable<UserResponse>> GetAllAsync(CancellationToken cancellationToken = default) =>
         await (from u in _context.Users
                ...
                .GroupBy(u => new { u.Id, u.FirstName, u.LastName, u.MembershipNumber, u.Birth_Of_Date, u.Renewal_date, u.Image, u.IsDisabled })
    ...
    public async Task<Result> UpdateProfileAsync(string userId,  [FromForm] UpdateProfileRequest request)
    {
