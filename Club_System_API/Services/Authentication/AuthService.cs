        ...
        public async Task<Result<AuthResponse>> GetTokenAsync(string PhoneNumber, string password, CancellationToken cancellationToken = default)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var userMembership = await _context.UserMemberships
                    ...
                    .Where(um => um.ApplicationUserId == user.Id)
                ...
                if (userMembership != null)
                {
                    ...
                    membershipDto = new MembershipDetailsDto(
                        membership.Id,
                        membership.Name,
                ...
                var services = bookings.Select(b => new ServiceBookingDto(
                    b.Id,
                ...
                var response = new AuthResponse(
                    ...
                    user.PhoneNumber,
                    user.UserMemberships.Select(x => x.Membership.Id).FirstOrDefault(),
                    token,
                    expiresIn,
                    refreshToken,
