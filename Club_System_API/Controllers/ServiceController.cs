...
namespace Club_System_API.Controllers
{
    ...
    public class ServiceController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] CoachRequest request,
       CancellationToken cancellationToken)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] CoachRequest request,
        CancellationToken cancellationToken)
        {
